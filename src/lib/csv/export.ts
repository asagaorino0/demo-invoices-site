  ...
  return [...input.serviceLines]
    ...
    .map((line) => {
      ...
      return {
        ...
        issuerBoxOffsetX: stringifyNumber(project.issuerBoxOffsetX || 0),
        issuerBoxOffsetY: stringifyNumber(project.issuerBoxOffsetY || 0),
        issuerBoxWidth: stringifyNumber(project.issuerBoxWidth || 0),
        stampOffsetX: stringifyNumber(project.stampOffsetX || 0),
        stampOffsetY: stringifyNumber(project.stampOffsetY || 0),
        notesBoxHeight: stringifyNumber(project.notesBoxHeight || 0),
